...
class DeathScene extends Scene {
     ...
     * @param primaryStage Stage for the scene.
     * @param amountOfFruitEaten The amount of Fruit eaten in the last game.
     * @param minimumGameTickLength The speed settings for the last game.
     */
    private void setupDeathScene(Group parentGroup, Stage primaryStage, int amountOfFruitEaten, int minimumGameTickLength) {
        ...
        int speedMultiplier = 400/minimumGameTickLength;
